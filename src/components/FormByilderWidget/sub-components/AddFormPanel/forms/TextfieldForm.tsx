...
const TextfieldForm: FC = () => {
    ...
    return (
        <form className={styles.form} onSubmit={handleSubmit(handleAdd)}>
            ...
            <label>
                Min. Lenght:
                <input {...register("minLenght")} type="number" className={styles.form__lenghtInput} placeholder="-"/>
            </label> 

            <label>
                Max. Lenght:
                <input {...register("maxLenght")} type="number" className={styles.form__lenghtInput} placeholder="-"/>
            </label>
